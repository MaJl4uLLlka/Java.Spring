...
import com.example.mainspingproject.exceptions.Response;
...
public class ControllerAdvisor {
    ...
    protected ResponseEntity<Response> handleAuthenticationException(UniqueEmailException e) {
        Response response = new Response(e.getMessage());
    ...
    public ResponseEntity<Response> onConstraintValidationException(
